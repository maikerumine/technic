...
minetest.register_craft({
    ...
    recipe = {
        ...
        {'default:glass', 'technic:control_logic_unit', 'default:glass'},
        {'default:mese_crystal', 'technic:copper_coil', 'default:mese_crystal'},
        }
})]]
...
minetest.register_craft({
	...
	recipe = {
		{'es:aikerum_crystal',   'technic:wrought_iron_ingot', 'es:aikerum_crystal'},
...
minetest.register_craft({
	...
	recipe = {
		{'es:aikerum_crystal',   'technic:carbon_steel_ingot', 'es:aikerum_crystal'},
...
minetest.register_craft({
	...
	recipe = {
		{'es:aikerum_crystal',      'technic:stainless_steel_ingot', 'es:aikerum_crystal'},
